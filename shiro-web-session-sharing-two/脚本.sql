...
INSERT INTO `tbl_user_role`(user_id, role_code) VALUES ( '00000012', 'ADMIN');
INSERT INTO `tbl_user_role`(user_id, role_code) VALUES ( '00000013', 'MARKET' );
INSERT INTO `tbl_user_role`(user_id, role_code) VALUES ( '00000013', 'XLOAN');


INSERT INTO `tbl_resource` VALUES (1,  'systemPage',              '系统组织管理','/systemPage', 1, 0, 0, 0, NULL, '2018-6-4 11:32:30', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (2,  'usersPage',               '用户管理',    '/usersPage', 1, 1, 2, 0, NULL, '2018-6-4 11:32:35', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (3,  'rolesPage',               '角色管理',    '/rolesPage', 1, 1, 3, 0, NULL, '2018-6-4 11:32:52', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (5,  'usersAdd',                '添加用户',    '/users/add', 2, 2, 5, 0, NULL, '2018-6-4 11:33:02', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (6,  'usersDelete',             '删除用户',    '/users/delete', 2, 2, 6, 0, NULL, '2018-6-4 11:33:11', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (7,  'rolesAdd',                '添加角色',    '/roles/add', 2, 3, 7, 0, NULL, '2018-6-4 11:33:21', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (8,  'rolesDelete',             '删除角色',    '/roles/delete', 2, 3, 8, 0, NULL, '2018-6-4 11:33:32', NULL, NULL, NULL);
...
INSERT INTO `tbl_resource` VALUES (11, 'usersSaveUserRoles',      '分配角色',   '/users/saveUserRoles', 2, 2, 11, 0, NULL, '2018-6-4 11:34:02', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (13, 'rolesSaveRoleResources',  '分配权限',   '/roles/saveRoleResources', 2, 3, 12, 0, NULL, '2018-6-4 11:34:12', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (14, 'auditPage',               '待审核',     '/auditPage', 1, 0, 13, 0, NULL, '2018-6-4 11:34:16', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (15, 'organizePage',            '机构管理',   '/organizePage', 1, 1, 1, 0, NULL, '2018-6-4 11:34:20', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (17, 'auditEdit',               '复核',       '/audit/edit', 2, 14, 16, 0, NULL, '2018-6-4 11:34:31', NULL, NULL, NULL);
INSERT INTO `tbl_resource` VALUES (18, 'auditRead',               '复核查看',   '/audit/read', 2, 14, 17, 0, NULL, '2018-6-4 11:34:53', NULL, NULL, NULL);


INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'systemPage'             );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'usersPage'              );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'rolesPage'              );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'usersAdd'               );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'usersDelete'            );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'rolesAdd'               );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'rolesDelete'            );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'resourcesAdd'           );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'resourcesDelete'        );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'usersSaveUserRoles'     );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'rolesSaveRoleResources' );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('MARKET', 'auditEdit');
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'systemPage'             );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'usersPage'              );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'rolesPage'              );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'usersAdd'               );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'usersDelete'            );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'rolesAdd'               );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'rolesDelete'            );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'resourcesAdd'           );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'resourcesDelete'        );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'usersSaveUserRoles'     );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'rolesSaveRoleResources' );
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'auditEdit');
INSERT INTO `tbl_role_resource`(role_code,res_code) VALUES ('XLOAN', 'auditRead');
